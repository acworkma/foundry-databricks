...
- A **Genie Space** over the sample tables (see
  [`docs/integration/pattern-a-genie-mcp.md`](../docs/integration/pattern-a-genie-mcp.md)).
...
### 2. Add the Unity Catalog Functions tool (Pattern B)
Follow [`docs/integration/pattern-b-uc-functions-mcp.md`](../docs/integration/pattern-b-uc-functions-mcp.md)
...
### 3. Add the Genie tool (Pattern A)
Follow [`docs/integration/pattern-a-genie-mcp.md`](../docs/integration/pattern-a-genie-mcp.md)
...
- Genie in preview is rate-limited (about 5 questions/minute) — prefer the deterministic
  Pattern B functions for the demo tables and use Genie for ad-hoc questions.
